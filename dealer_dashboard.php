    ...
    <div>
         <ul class="list-unstyled px-2">
                ...
                <li class=""><a href="#" class="text-decoration-none px-3 py-2 d-block "><i class="bi bi-person"></i>
                        Reservations</a></li>
                <li class=""><a href="#" class="text-decoration-none px-3 py-2 d-block "><i class="bi bi-person"></i> Total Orders</a></li>
...
<div class="productdealer">
    <h1>Details of Product Categories that User can Search</h1>
