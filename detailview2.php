...
<button style="color:white; background-color: #fca311; "id="query1">Send Query Request...</button>
<button style="color:white; background-color: black;"><a href="browse_catalog.php">Browse Catalog...</a></button><br><br>
...
<div class="media" >
	...
	<div class="media-body">
		...
		<p>Purza Online is a platform where you can find your desired products of your autos!</p>
	</div>
</div>
